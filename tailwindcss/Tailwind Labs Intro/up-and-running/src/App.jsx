  ...
  return (
    <div>
      <div className='grid bg-gray-100 lg:grid-cols-2 2xl:grid-cols-5'>
        <div
          className='max-w-md px-8 py-12 mx-auto center sm:max-w-xl lg:px-12 lg:py-24 lg:max-w-full xl:mr-0 2xl:col-span-2'
        >
        ...
        <div className="max-w-md px-8 py-8 mx-auto sm:max-w-xl lg:max-w-6xl lg:px-12">
          ...
          <div className="grid gap-6 mt-6 lg:grid-cols-2 xl:grid-cols-3">
            {destinations.map((destination) => (
              <DestinationCard destination={destination} key={destination.city}></DestinationCard>
            ))}
          </div>
      </div>
    </div>
